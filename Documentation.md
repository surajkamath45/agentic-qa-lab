...
> **Stack:** Python 3.14 · Playwright · Agent Framework · TypeScript · Manifest-Driven Architecture
...
8. [Data Flow & Artifact Lifecycle](#8-data-flow--artifact-lifecycle)
9. [Skills Catalogue](#9-skills-catalogue)
10. [Output Artifacts](#10-output-artifacts)
11. [Environment & Dependency Architecture](#11-environment--dependency-architecture)
12. [CI/CD Integration](#12-cicd-integration)
13. [Design Principles & Decision Log](#13-design-principles--decision-log)
